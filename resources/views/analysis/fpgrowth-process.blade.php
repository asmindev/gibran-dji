...
@section('title', 'Proses Algoritma FP-Growth')
...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Proses Algoritma FP-Growth</h1>
            <p class="text-gray-600 mt-2">Pemahaman langkah demi langkah algoritma FP-Growth (Frequent Pattern Growth)
            </p>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 mb-8 border border-green-200">
        <h2 class="text-xl font-semibold text-green-800 mb-4">🎯 Tentang Algoritma FP-Growth</h2>
        <div class="grid md:grid-cols-2 gap-6">
            <div>
                <p class="text-gray-700 mb-4">
                    <strong>FP-Growth (Frequent Pattern Growth)</strong> adalah algoritma efisien untuk association-rule
                    mining
                    yang menggunakan struktur data FP-Tree (Frequent Pattern Tree) untuk menemukan frequent patterns
                    tanpa
                    generate-and-test kandidat seperti Apriori:
                </p>
                <div class="bg-white p-4 rounded-lg border-l-4 border-green-500">
                    <em class="text-green-700">"Jika pelanggan membeli Item A, mereka juga cenderung membeli Item
                        B."</em>
                </div>
            </div>
            <div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <form method="GET" action="{{ route('analysis.fpgrowth-process') }}" class="flex flex-col lg:flex-row gap-4">
            <div class="flex-1">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end gap-3">
                <button type="submit"
                    class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md whitespace-nowrap">
                    <i class="fas fa-calculator mr-2"></i>Hitung FP-Growth
                </button>
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-green-600 to-blue-700 text-white p-6">
            <h3 class="text-xl font-semibold flex items-center">
                <span
                    class="bg-white text-green-600 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">
                    {{ $step['step'] }}
                </span>
                {{ $step['title'] }}
            </h3>
            <p class="mt-2 text-green-100">{{ $step['description'] }}</p>
        </div>
        ...
        <div class="p-6">
            ...
            @elseif($step['step'] === 'B')
            <!-- F-List (Frequent Items List) -->
            <div class="mb-4 bg-green-50 border-l-4 border-green-500 p-4 rounded">
                <p class="text-sm text-green-700">
                    <strong>📋 F-List (Frequent Items List):</strong> Items dengan support ≥ {{ $minSupport }}% dipertahankan dalam F-List dan akan digunakan untuk membentuk FP-Tree.
                </p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full table-auto">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach($step['data'] as $item)
                        @php
                            $isKept = ($item['support'] ?? 0) >= $minSupport;
                        @endphp
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div class="flex flex-wrap gap-1 items-center">
                        ...
                        <span class="inline-flex px-2 py-1 text-xs bg-green-100 text-green-800 rounded-full font-medium">
                            {{ trim($item) }}
                        </span>
            ...
            <div class="text-center py-8">
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-6 inline-block">
                    <h4 class="text-lg font-semibold text-green-800 mb-2">Tidak Dapat Membentuk 3-Itemsets</h4>
                    <p class="text-green-700 italic">{{ $step['data'][0]['note'] }}</p>
                </div>
                @else
            ...
            <table class="min-w-full table-auto">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="{{ $rule['status'] === 'weak' ? 'bg-red-50' : 'bg-green-50' }}">
                        ...
                        <td class="px-4 py-2 text-sm text-green-700 italic">{{ $rule['description'] }}</td>
...
<div class="bg-white rounded-lg shadow-md p-6 mt-8">
    ...
    <div class="grid md:grid-cols-5 gap-6">
        <div class="text-center">
            <div class="text-3xl font-bold text-green-600">{{ $algorithmSteps['summary']['total_transactions'] ?? 0 }}
            </div>
        ...
        <div class="bg-white rounded-lg p-4 shadow-sm">
            ...
            <div class="text-center">
                ...
                if ($execTime < 100) { $category='🚀 Sangat Cepat' ; $color='text-green-600' ; $bgColor='bg-green-100' ;
                    } elseif ($execTime < 500) { $category='⚡ Cepat' ; $color='text-green-600' ; $bgColor='bg-green-100'
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div class="flex justify-between items-center bg-white p-2 rounded text-sm">
                    ...
                    <span class="font-medium text-green-600">{{ $algorithmSteps['summary']['step_timings']['step1']
                        }}ms</span>
                </div>
                @endif
                ...
                <div
                    class="flex justify-between items-center bg-green-100 p-2 rounded text-sm border-2 border-green-200">
                    <span class="text-green-800 font-medium">Total Algorithm:</span>
                    <span class="font-bold text-green-800">{{ $algorithmSteps['summary']['algorithm_time_ms']
                        }}ms</span>
                </div>
                @endif
            </div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                <h4 class="font-semibold text-green-800 mb-2">📊 Informasi Aturan Asosiasi</h4>
                <div class="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                        <span class="font-medium text-gray-700">Aturan:</span>
                        <span id="modalRule" class="text-green-600 font-medium ml-1"></span>
                    </div>
                    <div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <!-- Consequent Product -->
                <div class="bg-gradient-to-br from-green-50 to-blue-100 border border-green-200 rounded-lg p-6">
                    <div class="flex items-center mb-4">
                        <div
                            class="bg-green-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">
                            C
                        </div>
                        <h5 class="text-lg font-semibold text-green-800">Produk Consequent</h5>
                    </div>
                    <div class="space-y-3">
                        <div class="bg-white rounded-lg p-4 shadow-sm">
                            <!-- Product Image -->
