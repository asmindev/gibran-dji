        ...
        <div class="p-6">
            ...
            <div class="mb-4 bg-green-50 border-l-4 border-green-500 p-4 rounded">
                <p class="text-sm text-green-700">
                    <strong>📋 F-List (Frequent Items List):</strong> Items dengan support ≥ {{ $minSupport }}%
                    dipertahankan dalam F-List dan akan digunakan untuk membentuk FP-Tree.
                </p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('FP-Growth analysis page loaded');
});
