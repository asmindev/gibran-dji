    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm text-gray-600 font-medium">Stok Menipis</p>
                    <p class="text-2xl font-bold text-red-600">{{ $lowStockItems->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm text-gray-600 font-medium">Total Stok</p>
                    <p class="text-2xl font-bold text-gray-900">{{ number_format(\App\Models\Item::sum('stock')) }}</p>
                </div>
            </div>
        </div>
    </div>
