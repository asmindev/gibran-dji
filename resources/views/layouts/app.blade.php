        ...
        <div class="hidden md:flex md:w-64 md:flex-col">
            <div class="flex flex-col flex-grow bg-white shadow-xl border-r border-gray-200 overflow-y-auto">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <a href="{{ route('analysis.fpgrowth-process') }}"
                        class="@if(request()->routeIs('analysis.fpgrowth-process')) bg-primary text-white @else text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="w-64 bg-white shadow-xl h-full overflow-y-auto">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('analysis.compare') }}"
                                class="@if(request()->routeIs('analysis.compare')) bg-orange-100 text-orange-700 @else text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200 ml-4"
                                onclick="toggleMobileSidebar()">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z">
                            ...
                            <a href="{{ route('analysis.fpgrowth-process') }}"
                                class="@if(request()->routeIs('analysis.fpgrowth-process')) bg-orange-100 text-orange-700 @else text-gray-600 hover:bg-gray-100 hover:text-gray-900 @endif flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200 ml-4"
                                onclick="toggleMobileSidebar()">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z">
