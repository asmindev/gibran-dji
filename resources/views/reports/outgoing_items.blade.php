...
@section('title', 'Outgoing Items Report')
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-red-500 to-red-600 text-white">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold">Outgoing Items Report</h1>
        ...
        <div class="p-6 bg-gray-50 border-b">
            <form method="GET" action="{{ route('reports.outgoing') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                ...
                <div>
                    ...
                    <select id="purpose" name="purpose"
                        ...
                        <option value="Internal Use" {{ request('purpose')=='Internal Use' ? 'selected' : '' }}>Internal
                            Use</option>
                        <option value="Damaged" {{ request('purpose')=='Damaged' ? 'selected' : '' }}>Damaged</option>
                        <option value="Return" {{ request('purpose')=='Return' ? 'selected' : '' }}>Return</option>
                        <option value="Transfer" {{ request('purpose')=='Transfer' ? 'selected' : '' }}>Transfer
                        </option>
                ...
                <div class="flex items-end">
                    <button type="submit"
                        class="w-full px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md font-medium transition duration-200">
                        Apply Filters
                    </button>
                </div>
            </form>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                        @if($item->purpose == 'Sale') bg-green-100 text-green-800
                                        @elseif($item->purpose == 'Damaged') bg-red-100 text-red-800
                                        @elseif($item->purpose == 'Return') bg-yellow-100 text-yellow-800
